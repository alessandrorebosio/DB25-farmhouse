...
% colori (uso HTML per esadecimale, compatibile con xcolor)
\definecolor{codegray}{rgb}{0.5,0.5,0.5}
\definecolor{codeBlue}{HTML}{6495ED}
\definecolor{codegreen}{HTML}{12911F}
\definecolor{backcolour}{rgb}{0.95,0.95,0.92}

% stile specifico e con nome unico per evitare conflitti
...
% ambiente dedicato, sempre con nome unico
...
\begin{enumerate}
	...
	\item {\large \textbf{Inserimento recensione}} \label{op3}
	...
	\item {\large \textbf{Analisi servizi più inclusi nei pacchetti}} \label{op14}
	      $$
		      {Op}_{sett} = 1
	      $$
