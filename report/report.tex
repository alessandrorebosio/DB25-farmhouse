...
\subsection{Analisi attributo \texttt{quantità} in \texttt{DETTAGLIO\_ORDINE}}
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|c|>{\raggedright\arraybackslash}X|c|c|}
		\hline
		\rowcolor{gray!20}
		\textbf{\#} & \textbf{Operazione} & \textbf{Costo tot. / 1 mese} & \textbf{Tipo Utente} \\
		\hline
		22 & Calcolo fatturato mensile per servizio & 25.700 & Admin \\
		\hline
	\end{tabularx}
	\caption{Costi delle operazioni mensili, con tipo di utente che le effettua}
	\label{tab:costo-operazioni-mensili}
\end{table}
